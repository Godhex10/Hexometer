/**
 * @author sham-nt <https://github.com/sham-nt>
 */
  ...
  fetchData(url.currentWeather(lat, lon), function (currentWeather) {
    ...
    fetchData(url.forecast(lat, lon), function (forecast) {
      ...
      for (const [index, data] of forecastList.entries()) {
        ...
        tempLi.innerHTML = `
          <div class="card card-sm slider-card" style="
    ...
    ">
      ...
      forecastSection.innerHTML = `
        ...
        <div class="card card-lg forecast-card" style='box-shadow: -12px 10px 9px 3px #0a0a0a, inset -5px -7px 20px 0px #1e1e1e;'>
